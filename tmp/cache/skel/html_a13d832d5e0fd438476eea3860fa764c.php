...
// Temps de compilation total: 3.790 ms
//
...
'<'.'?php echo recuperer_fond( ' . argumenter_squelette('prive/squelettes/body') . ', array_merge('.var_export($Pile[0],1).',array(\'espace_prive\' => ' . argumenter_squelette('1') . ',
	\'lang\' => ' . argumenter_squelette($GLOBALS["spip_lang"]) . ')), array("compil"=>array(\'../prive/squelettes/structure.html\',\'html_a13d832d5e0fd438476eea3860fa764c\',\'\',13,$GLOBALS[\'spip_lang\'])), _request("connect"));
?'.'>
</html>
');
