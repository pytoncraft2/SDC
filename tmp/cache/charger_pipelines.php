...
include_once_check(_ROOT_PLUGINS.'auto/saisies/v3.43.0/saisies_pipelines.php');
$inc=true;
}
...
include_once_check(_ROOT_PLUGINS_DIST.'statistiques/stats_pipelines.php');
include_once_check(_ROOT_PLUGINS.'auto/couteau_suisse/v1.10.19/cout_pipelines.php');
include_once_check(_ROOT_PLUGINS.'auto/menus/v1.7.26/menus_pipelines.php');
include_once_check(_ROOT_PLUGINS_DIST.'breves/breves_pipelines.php');
...
$val = minipipe('menus_affiche_milieu', $val);
...
include_once_check(_ROOT_PLUGINS_DIST.'urls_etendues/urls_pipeline.php');
include_once_check(_ROOT_PLUGINS.'auto/menus/v1.7.26/inc/menus_autoriser.php');
...
include_once_check(_ROOT_PLUGINS.'auto/couteau_suisse/v1.10.19/cout_pipelines.php');
include_once_check(_ROOT_PLUGINS.'auto/menus/v1.7.26/base/menus_tables.php');
...
$val = minipipe('menus_declarer_tables_objets_sql', $val);
...
$val = minipipe('menus_declarer_tables_auxiliaires', $val);
...
static $inc=null;
if (!$inc){
include_once_check(_ROOT_PLUGINS.'auto/facteur/v4.1.0/facteur_fonctions.php');
$inc=true;
}
...
$val = minipipe('menus_optimiser_base_disparus', $val);
...
include_once_check(_ROOT_PLUGINS.'auto/menus/v1.7.26/menus_ieconfig.php');
include_once_check(_ROOT_PLUGINS.'auto/facteur/v4.1.0/facteur_ieconfig_metas.php');
...
$val = minipipe('menus_ieconfig_metas', $val);
...
function execute_pipeline_menus_utiles(&$val){
return $val;
}
